...
export const getTechnologyIcon = (tech: string) => {
  switch(tech.toLowerCase()) {
    ...
    case "scikit-learn":
      return <ScikitlearnOriginal className="h-4 w-4" />
    case "pandas":
      return <PandasOriginal className="h-4 w-4" />
    ...
    case "arduino":
      return <ArduinoOriginal className="h-4 w-4"/>

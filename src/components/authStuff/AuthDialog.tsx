        ...
        <Dialog open={isOpen} onOpenChange={close}>
            <DialogContent className="sm:max-w-[400px] rounded-2xl p-6 shadow-xl border bg-white dark:bg-zinc-900">
                ...
                <DialogHeader className="text-center mb-4">
                    <DialogTitle className="text-2xl font-semibold">Power Projects</DialogTitle>
                    <p className="text-sm text-muted-foreground">Sign in or create your account</p>
                </DialogHeader>

                <Tabs value={view} onValueChange={(val) => setView(val as "signin" | "signup")} className="w-full">
